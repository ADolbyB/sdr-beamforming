...
class local_SP_PhaseSync(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        labels = ['Rx2', '', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        labels = ['Rx1', '', 'Signal 3', 'Signal 4', 'Signal 5',
            'Signal 6', 'Signal 7', 'Signal 8', 'Signal 9', 'Signal 10']
        widths = [1, 0, 1, 1, 1,
            1, 1, 1, 1, 1]
        ...
        labels = ['Tx1', '', 'Signal 3', 'Signal 4', 'Signal 5',
            'Signal 6', 'Signal 7', 'Signal 8', 'Signal 9', 'Signal 10']
        widths = [1, 0, 1, 1, 1,
            1, 1, 1, 1, 1]
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, Tx1_path, False)
        ...
        self.connect((self.low_pass_filter_1, 0), (self.qtgui_freq_sink_x_0_0_0, 0))
        self.connect((self.low_pass_filter_1, 0), (self.qtgui_time_sink_x_0_0_0, 0))
    ...
    def set_Tx1_path(self, Tx1_path):
        ...
        self.blocks_file_sink_0.open(self.Tx1_path)
